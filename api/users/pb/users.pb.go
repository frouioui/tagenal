...
func (x *UserRequest) GetA() uint64 {
	if x != nil {
		return x.A
	}
	return 0
...
func (x *UserRequest) GetB() uint64 {
	if x != nil {
		return x.B
	}
	return 0
...
func (x *UserResponse) GetResult() uint64 {
	if x != nil {
		return x.Result
	}
	return 0
...
var file_pb_users_proto_rawDesc = []byte{
	...
	0x12, 0x02, 0x70, 0x62, 0x22, 0x29, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x0c, 0x0a, 0x01, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x01,
	0x61, 0x12, 0x0c, 0x0a, 0x01, 0x62, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x01, 0x62, 0x22,
	...
	0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x3b, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2c, 0x0a, 0x07, 0x43, 0x6f, 0x6d, 0x70, 0x75, 0x74,
	...
	0x6f, 0x6d, 0x2f, 0x66, 0x72, 0x6f, 0x75, 0x69, 0x6f, 0x75, 0x69, 0x2f, 0x74, 0x61, 0x67, 0x65,
	0x6e, 0x61, 0x6c, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_pb_users_proto_depIdxs = []int32{
	0, // 0: pb.UserService.Compute:input_type -> pb.UserRequest
	1, // 1: pb.UserService.Compute:output_type -> pb.UserResponse
